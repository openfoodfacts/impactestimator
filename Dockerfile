...
RUN python -m pip install pyscipopt statsmodels sklearn ipython openfoodfacts fastapi uvicorn[standard] progressbar2 aiohttp bson python-multipart pytype
